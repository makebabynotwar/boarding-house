<template>
    <div class="admin-dashboard">
            ...
            <div class="inner_main">
                <div class="main_heading">
                    ...
                    <div class="header_button">
                        <a href="javascript:;" class="btn orange" @click="add_amenities = true">
                            Add New Amenities
                        </a>
                    </div>
                </div>
                <div class="main_body">
                    ...
                    <div class="default_container">
                        <div class="custom_datatable">
                            <table class="">
                                <colgroup>
                                    <col width="10%"><col width="30%"><col width="10%">
                                </colgroup>
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <th class="amenity_no"><span>Amenity No.</span></th>

                                        <th class="room_payment"><span>Amenity</span></th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="room_payment"><span>TV</span></td>
        ...
        <AddAmenities v-if="add_amenities" @close="add_amenities = false"/>
    </div>
</template>

<script>
import AddAmenities from '@/components/Modal/AddAmenities';
export default {
    components:{
        AddAmenities
    },
