    ...
    <div class="register_page">
        ...
        <div class="register_form">
            <form @submit.prevent="register">
                ...
                <button :class="['submit', { load: loading }]" :disabled="loading" type="submit">Submit</button>
            </form>
	    </div>
    </div>
</template>
...
export default {
    ...
    created(){
        this.$store.dispatch('title/setTitle', 'Register');
    },
    methods: {
        register() {
            ...
            for (let [key, value] of Object.entries(this.form)) {
                if (key == 'contact_number' && !phoneNumberRegex.test(value)) {
